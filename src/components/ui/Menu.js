...
const Menu = props => {
  ...
  const exportTxtFileToDownloads = (obj, filename) => {
    ...
    props.setMessage({
      ...
      message: `Die Datei befindet sich im Ordner Downloads ! Dateiname: ${filename}_${dateNow}.txt`,
      showBtnX: false,
    });
  };
  //==================================================================
...
const exampleList = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        ingredientName: 'Hänchnchenfleisch',
        quantity: '400',
        unit: 'g',
